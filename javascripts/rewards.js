const REWARDS = [
    [
        () => [new Variable(['a','b','c','d','e','f'][Math.floor(Math.random() * 6)]), randInt(1,2)],
        () => [new Constant(randInt(1,5)), randInt(1,2)],
        () => [new Operator(OperatorType.SetVariable), 1],
        () => [new Operator(OperatorType.Sum), 1],
        () => [new Operator(OperatorType.AddVariable), 1],
    ],
    [
        () => [new Operator(OperatorType.Product, null, new Slot(0, new Constant(2), true)), 1],
